...
let files = [
    "_pages/transcripts/pre-1955/youngstown-sheet-amp-tube-co-v-sawyer.md"
...
let speakerMappings = {
    "MR. CHIEF JUSTICE VINSON": "Chief Justice Fred M. Vinson",
    // "MR. CHIEF JUSTICE WARREN": "Chief Justice Earl Warren",
    "MR. JUSTICE BLACK": "Justice Hugo Lafayette Black",
    "MR. JUSTICE BURTON": "Justice Harold Hitz Burton",
    "MR. JUSTICE CLARK": "Justice Tom C. Clark",
    "MR. JUSTICE DOUGLAS": "Justice William Orville Douglas",
    ...
    "MR. JUSTICE REED": "Justice Stanley Forman Reed",
    "THE CLERK": "The Clerk",
    ...
    "MR. GOLDBERG": "Arthur J. Goldberg",
    "MR. HEISS": "Harold C. Heiss",
    "MR. O’BRIEN": "Clifford D. O'Brien",
    "MR. PERLMAN": "Philip B. Perlman"
};
...
{
    if (argv[1]) {
        let text = fs.readFileSync(argv[1], "utf8");
        countWords(text);
        return;
    }
