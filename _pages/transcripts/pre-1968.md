...
In 2005, I visited the [U.S. Supreme Court Library](/blog/2019/03/02/), and with librarian
Brian Stiglmeier's help, I was able to browse their small collection of Pre-1968 Transcripts
and duplicate a few of them.  PDF versions of those transcripts are now available
[below](#selected-pre-1968-transcripts).

In addition, the Library gave me a document titled "[Oral Arguments Available in the U.S. Supreme
Court Library Prior to the 1968 Term](#oral-arguments-available-in-the-us-supreme-court-library-prior-to-the-1968-term)".
The contents of that 2005 document have been reproduced below.
...
Publications of America microfiche collection), while others are available in the "Landmark Briefs
and Arguments" collection (eg, *Adamson v. California*, *Ashwander v. Tennesee Valley Authority*,
etc).  I've attempted to **highlight** any cases below that *may* be a unique holding.

It's also possible that many of the following transcripts may be considered unique insofar as they
differ from what's available on microfiche, because many of the UPA transcripts were recreated after
...
by a court reporter.  However, that's not always true.  For example, I distinctly recall that
the Library's transcript for *Youngstown v. Sawyer* was simply a copy of the transcript printed in
