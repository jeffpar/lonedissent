...
The contents of that 2005 document have been reproduced [below](#oral-arguments-available-in-the-us-supreme-court-library-prior-to-the-1968-term).

A few notes about the list, from my March 3, 2005 trip report:

- Just because a case is on the list doesn't mean the Library currently has it.  For example, I asked for a 1903 case -- *Northern Securities v. US* (193 U.S. 197), Case No. 277 -- and all Brian could tell me was that it wasn't there.
...
and Arguments" collection (eg, *Adamson v. California*, *Ashwander v. Tennessee Valley Authority*,
etc).  I've attempted to **highlight** any cases below that fall outside those collections and
